INSERT INTO uzytkownicy(login, data_urodzenia, email, haslo, imie, liczba_ocen, miejscowosc, nazwisko, numer_telefonu, rola, suma_ocen, ulica, wojewodztwo, zablokowany) VALUES ('admin', '1995-10-02 00:00:00.000', 'p.podbielski@gmail.com', 'pass1234', 'Piotr', 0, 'Warszawa', 'Podbielski', '123456789', 'ROLE_ADMIN', 0, 'ul. 3 Maja 13', 'mazowieckie', 0), ('marcinexxx', '1995-10-02 00:00:00.000', 'p.podbielski@gmail.com', 'pass1234', 'Marcin', 0, 'Warszawa', 'Marcinkowski', '123456789', 'ROLE_USER', 0, 'ul. 3 Maja 13', 'mazowieckie', 0), ('adamexxx', '1995-10-02 00:00:00.000', 'p.podbielski@gmail.com', 'pass1234', 'Adam', 0, 'Warszawa', 'R.', '123456789', 'ROLE_USER', 0, 'ul. 3 Maja 13', 'mazowieckie', 1);
...
INSERT INTO zlecenia_transportu (data_zlecenia, kategoria_paczki, komentarz, rozmiar_paczki, status_zlecenia, waga_paczki, oferta_id, uzytkownik_id) VALUES ('2018-12-20 00:00:00.000', 'zwierzęta', '', 'duża', 'DO_ROZPATRZENIA', 123, SCOPE_IDENTITY(), 'marcinexxx');
...
INSERT INTO oferty (cena_maksymalna, aktywna, cena_minimalna, czy_wyroznic, data_wyjazdu, godzina_wyjazdu, kategorie_paczek, maksymalna_waga_paczki, miasto_docelowe, miasto_poczatkowe, opis, rozmiary_paczek, tytul, zablokowana, uzytkownik_id) VALUES (25, 1, 15, 0, '2017-12-21 00:00:00.000', '1970-01-01 15:00:00.000', 'żywność,szkło,zwierzęta,rośliny', 25, 'Warszawa', 'Kraków', 'Zrealizowana', 'mała,srednia,duża', 'Zrealizowana', 0, 'marcinexxx');

INSERT INTO zlecenia_transportu (data_zlecenia, kategoria_paczki, komentarz, rozmiar_paczki, status_zlecenia, waga_paczki, oferta_id, uzytkownik_id) VALUES ('2017-12-19 00:00:00.000', 'zwierzęta', '', 'duża', 'ZAAKCEPTOWANO', 123, SCOPE_IDENTITY(), 'admin');

INSERT INTO powiadomienia (data_dodania, id_typu_powiadomienia, przeczytane, typ_powiadomienia, uzytkownik_id) VALUES ('2017-12-20 00:00:00.000', CONVERT(varchar(255), SCOPE_IDENTITY()), 0, 'ZMIANA_STATUSU_ZLECENIA', 'admin');
